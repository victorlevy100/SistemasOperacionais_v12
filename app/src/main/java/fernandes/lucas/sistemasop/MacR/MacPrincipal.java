package fernandes.lucas.sistemasop.MacR;
...
public class MacPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mac_principal);

        lstWindows = new ArrayList<>();
        lstWindows.add(new Windows("Mavericks","Sistema Operacional","OS X v10.9 Mavericks é a décima versão do OS X, sistema operacional para. OS X Mavericks foi anunciado em 10 de junho de 2013 e lançado no dia 22 de Outubro de 2013 como uma atualização gratuita através da Mac App Store. O Sistema Operacional possui funções que melhoram a duração da bateria, além de melhorias no Finder e maior integração ao iCloud. \n" +
                ...
                "\n"+
                "• Adição do aplicativo iBooks, para leitura de livros digitas;\n"+
                "\n"+
                "• Adição do aplicativo Mapas;\n"+
                "\n"+
                "• Compressão da memória, que comprime automaticamente os dados de aplicativos inativos quando se aproxima da capacidade máxima de memória;\n"+
                "\n"+
                ...
                "•OpenCL 1.2;\n"+
                "\n"+
                "•Assim como no novo IOS, o OS X 10.9 também suporta atualizações automáticas de sistema e de aplicativos;\n"+
                "\n"+
                "• Suporte ao protocolo IP na porta Thunderbolt, permitido a conexão entre dois Macs e a transferências de arquivos entre eles.\n"+
                "\n"+
                "REQUISITOS GERAIS:\n"+
                "\n"+
                ...
                "\n"+
                "• Algumas funcionalidades requerem uma Apple ID; aplicam-se os respectivos termos;\n"+
                "\n"+
                "• Algumas funcionalidades requerem um fornecedor de serviço de internet compatível; podem seer aplicados tarifários\n",R.drawable.maverickslogo,R.drawable.maverickssistema));
